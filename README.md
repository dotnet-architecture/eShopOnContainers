...
| <sup> <a href='https://aka.ms/microservicesebookMOBI'>**Download .MOBI/Kindle** (First Edition)</a> </sup> | ------------ |  ------------ | | <sup> <a href='https://aka.ms/microservicesebookEPUB'>**Download .EPUB** (First Edition)</a> </sup> | ------------ | ------------ |
